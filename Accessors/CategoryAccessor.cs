...
namespace RadialReview.Accessors {
	public class CategoryAccessor : BaseAccessor {
		...
		public static QuestionCategoryModel Edit(UserOrganizationModel user, long categoryId, Origin origin = null,
		...
		public static QuestionCategoryModel Get(UserOrganizationModel user, long id) {
			using (var s = HibernateSession.GetCurrentSession()) {
				using (var tx = s.BeginTransaction()) {
		...
		public static List<QuestionCategoryModel> GetCategories(UserOrganizationModel caller, long organizationId) {
			using (var s = HibernateSession.GetCurrentSession()) {
				using (var tx = s.BeginTransaction()) {

...
namespace RadialReview.Api.V1 {
    ...
    {
        public TeamsController(RadialReview.DatabaseModel.DatabaseContexts.RadialReviewDbContext dbContext, RedLockNet.IDistributedLockFactory redLockFactory) : base(dbContext, redLockFactory)
        {
        }
        ...
        [Route("teams/{TEAM_ID:long}/members")]
        [HttpGet]
        ...
        /// <returns></returns>
        [Route("teams/{TEAM_ID:long}/member/{USER_ID:long}")]
        [HttpPost]

...
namespace RadialReview.Areas.People.Angular.Survey {
	public class AngularSurveyContainer : BaseAngular, ISurveyContainer {
		...
		public AngularSurveyContainer(ISurveyContainer container, bool locked, AngularUser issuedBy) : base(container.Id) {
			...
			Surveys = container.GetSurveys().NotNull(y => y.Select(x => new AngularSurvey(x, null)).ToList());
			Locked = locked;
		...
		public string DueDateString {
			get { return DueDate == null ? "" : DueDate.Value.ToString("MMM-dd-yyyy"); }

		}

		public string IssueDateString {
			get { return IssueDate == null ? "" : IssueDate.Value.ToString("MMM-dd-yyyy"); }

...
namespace RadialReview.Areas.People.Engines.Surveys.Impl.QuarterlyConversation.Sections {
  public class ValueSection : ISectionInitializer {
    ...
    public static string ValueCommentHeading(TermsCollection terms) {
      return terms.GetTerm(TermKey.CoreValues) + " Comments";
    }

    public TermsCollection Terms;

    public ValueSection(TermsCollection terms) {
      Terms = terms;
    }
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public IEnumerable<IItemInitializer> GetItemBuilders(IItemInitializerData data) {
      ...
      var genComments = new InputItemIntializer(ValueCommentHeading(Terms), SurveyQuestionIdentifier.GeneralComment);
    ...
    public ISection InitializeSection(ISectionInitializerData data) {
      return new SurveySection(data, Terms.GetTerm(TermKey.CoreValues), SurveySectionType.Values, "mk-values");
    }

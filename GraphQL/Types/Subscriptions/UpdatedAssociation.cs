namespace RadialReview.Core.GraphQL.Types
{
  ...
  public partial class UpdatedAssociation<TBearer, TProperty, T, TKey> : Change<TBearer>
    where T : class
  {
    public override ChangeAction Action => ChangeAction.UpdatedAssociation;

    public Target<TProperty, TKey> Target
    {
      get; set;
    }
    ...
    public override void Log(ILogger<IChange<TBearer>> logger)
    {
      ...
      logger.Log(
        ...
        new(0, nameof(UpdatedAssociation<TBearer, TProperty, T, TKey>)),
        state,
        null,
        static (s, _) =>
        {

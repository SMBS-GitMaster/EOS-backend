...
namespace RadialReview.Models.Angular.Scorecard {
	...
	public class AngularMeasurable : BaseAngular, IAttachedPermission {
		...
		public static AngularMeasurable Create(L10Recurrence.L10Recurrence_Measurable meetingMeasurable) {
			if (meetingMeasurable.IsDivider) {
				return CreateDivider(meetingMeasurable);
			} else {
      ...
      HasV3Config = measurable.HasV3Config;
			...
			AverageRange = measurable.AverageRange;

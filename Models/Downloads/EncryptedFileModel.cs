...
namespace RadialReview.Models.Downloads {
	...
	public static class FileOriginExtensions {
		public static bool IsGenerated(this FileOrigin origin) {
			return origin == FileOrigin.UserGenerate || origin == FileOrigin.AutoGenerated || origin == FileOrigin.TemporaryAutoGenerated;
		}
	}
	...
	public class EncryptedFileModel {
		...
		public virtual ForModel ParentModel { get; set; }
		...
		public class Map : ClassMap<EncryptedFileModel> {
			public Map() {
				...
				Component(x => x.ParentModel).ColumnPrefix("ParentModel_");
	...
	public class TagModel {
		...
		public static TagModel Create(string tag, ForModel forModel) {
			return new TagModel(tag, forModel);
		}

		public class Constants {
			public static string QUARTERLY_PRINTOUT = "Quarterly Printout";

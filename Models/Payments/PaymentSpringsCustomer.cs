...
namespace RadialReview.Models.Payments {
	...
	public class PaymentSpringsToken : IHistorical, ILongIdentifiable {
		...
		public virtual decimal? LastSalesTaxRate { get; set; }
		public virtual DateTime? LastSalesTaxRateDate { get; set; }
		...
		public class PSTMap : ClassMap<PaymentSpringsToken> {
			public PSTMap() {
				...
				Map(x => x.LastSalesTaxRate);
				Map(x => x.LastSalesTaxRateDate);

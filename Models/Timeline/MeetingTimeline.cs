...
namespace RadialReview.Models.Timeline {
	...
	public class TimelineLookup {
		...
		private static Dictionary<string, Item> _lookup = new Dictionary<string, Item>(){
			...
			{"UpdateRockCompletion",    new Item("Update goal",         "#f0ad4e","icon fontastic-icon-bullseye")},
			{"CreateRock",              new Item("Create goal",         "#f0ad4e","icon fontastic-icon-bullseye")},

			{"CreateHeadline",          new Item("Create headline",     "#f0ad4e","glyphicon glyphicon-bookmark")},
			...
			{"ConcludeMeeting",         new Item("Wrap-up meeting",    "#f0ad4e","glyphicon glyphicon-stop")},
			...
			{"EditL10",                 new Item("Edit Weekly Meeting",            "#f0ad4e","glyphicon glyphicon-cog")},
			{"EditL10Recurrence",       new Item("Edit Weekly Meeting",            "#f0ad4e","glyphicon glyphicon-cog")},
			{"DeleteL10",               new Item("Delete Weekly Meeting",          "#f0ad4e","glyphicon glyphicon-trash")},
		};
	...
	public class TimelineItem {
		...
		public static TimelineItem Create(UserOrganizationModel viewer, L10AuditModel a, DefaultDictionary<long?,string> usernames) {
			...
			return new TimelineItem() {
				...
				User = usernames[a.UserOrganizationId],

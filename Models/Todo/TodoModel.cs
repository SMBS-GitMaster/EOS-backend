...
namespace RadialReview.Models.Todo {
  ...
  [DebuggerDisplay("Message = {Message}, Owner={AccountableUser}")]
	public partial class TodoModel : BaseModel, IDeletable, ILongIdentifiable, IIssue, ITodoTiny {
    ...
    public virtual string ContextNodeTitle { get; set; }
		...
		public virtual ForModel GetListSource() {
		...
		public class IssueMap : BaseModelClassMap<TodoModel> {
			public IssueMap() {
				Id(x => x.Id);
				Map(x => x.Ordering);

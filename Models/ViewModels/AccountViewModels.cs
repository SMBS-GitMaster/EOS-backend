...
namespace RadialReview.Models {
	public class PasswordConstants {
		public const string PasswordRegex = @"^(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&+=,~;:\\\'\""<>\\_\-`\.\[\]{}|/\*\(\)\?]).*$";
		public const string PasswordRegexError = @"Password must have 1 capital letter, 1 lowercase letter, and 1 special character: !@#$%^&+=,~;:\"";_-`.[]|/*()?";

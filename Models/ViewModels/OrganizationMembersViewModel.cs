...
namespace RadialReview.Models.ViewModels
{
	public class OrgMembersViewModel
	{
		...
		public OrgMembersViewModel(UserOrganizationModel caller, IEnumerable<UserLookup> members, OrganizationModel organization, bool hasAdminDelete, bool canUpgradeUsers, bool canEditUserDetails, bool canRemoveUsers, List<UserRole> roles)
		{
	...
	public class OrgMemberViewModel
	{
		...
		public V2StatusBar V2Status { get; set; }
		...
		public bool EnableWhale { get; set; }
		...
		public OrgMemberViewModel(UserOrganizationModel userOrg, bool forceCanDelete, IEnumerable<UserRole> roles)
		{
			...
			throw new Exception("goals roles measurables gone");
		}

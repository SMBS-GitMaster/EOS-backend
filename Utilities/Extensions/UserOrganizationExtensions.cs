...
namespace RadialReview {
	...
	public static partial class UserOrganizationExtensions {
		...
		public static String GetNameAndTitle(this UserOrganizationModel self, int positions = int.MaxValue, long _ = -1) {
			return self.GetName() + self.GetTitles(positions).Surround(" (", ")");
		}
    ...
    public static gqlUserAvatarColor MapToUserAvatarColor(int value)
    {
      switch (value % 5)
      {
        case 0:
          return gqlUserAvatarColor.COLOR1;
        case 1:
          return gqlUserAvatarColor.COLOR2;
        case 2:
          return gqlUserAvatarColor.COLOR3;
        case 3:
          return gqlUserAvatarColor.COLOR4;
        case 4:
          return gqlUserAvatarColor.COLOR5;
        default:
          throw new InvalidOperationException("Invalid value for UserAvatarColor mapping.");
      }
    }
    ...
    public static String ImageUrl(this UserOrganizationModel self, bool awsFaster = false, ImageSize size = ImageSize._64) {
		...
		public static Tree GetTree(this UserOrganizationModel self, ISession s, PermissionsUtility perms, List<long> deepClaims, long? youId = null, bool force = false, bool includeRoles = false) {
			...
			if (includeRoles) {
				var roles = RoleAccessor.Deprecated.GetRoles(s, perms, self.Id);
		...
		public static Boolean IsManagingOrganization(this UserOrganizationModel self, bool includeRadialAdmins = true) {
			if (includeRadialAdmins) {

...
namespace RadialReview.Utilities.Permissions.Resources {
	public class UpgradeUsersForOrganizationResourcePermissions : IResourcePermissions {

		public PermItem.ResourceType ForResourceType() {
			return PermItem.ResourceType.UpgradeUsersForOrganization;
		}
		...
		public ResourceMetaData GetMetaData(ISession s, long resourceId) {
			return new ResourceMetaData() {
				Name = "",
				Picture = PictureViewModel.CreateFromInitials("", "UpgradeUsers"),
			};
		}
